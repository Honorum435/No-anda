...
export default function AboutUs() {
  return (
    <section id="about" className="px-24 py-24 bg-[#F7F3EB] flex justify-center items-center">
      <div className="bg-white rounded-lg shadow-lg px-0 py-0 flex items-center max-w-5xl w-full relative">
        ...
        <div className="ml-[340px] px-12 py-14">
          ...
          <p className="mb-6 text-lg text-[#23423D] leading-relaxed">The legal definition of a charitable organization (and of charity) varies between countries and in some instances regions of the country. The regulation, the tax treatment, and the way in which charity law effects charitable organizations also vary.</p>
          <a href="#" className="text-[#23423D] font-semibold hover:underline text-lg">Read More</a>
        </div>
      </div>
    </section>
  );
